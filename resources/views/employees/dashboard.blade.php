...
<div class="panel p-4 mb-4">
    <div class="d-flex align-items-center gap-3">
        ...
        <div>
            ...
            <p class="label-mono mb-0 text-slate">
                Shift:
                @if ($employee->shift)
                    {{ $employee->shift->name }} ({{ $employee->shift->timeRangeLabel() }})
                @else
                    Not assigned
                @endif
            </p>
    ...
    <div class="row g-3 mb-4">
        <div class="col-md-4">
            <div class="stat-card accent-ink">
               ...
               <h3 class="mb-0">{{ $leaveBalances['annual'] }} <span class="small text-slate" style="font-size: 28px;">leaves left</span></h3>
            </div>
        </div>
        <div class="col-md-4">
            <div class="stat-card accent-success">
                <p class="label-mono mb-1">Sick Leave</p>
                <h3 class="mb-0">{{ $leaveBalances['sick'] }} <span class="small text-slate" style="font-size: 28px;">leaves left</span></h3>
            </div>
        </div>
        <div class="col-md-4">
            <div class="stat-card accent-slate">
                <p class="label-mono mb-1">Casual Leave</p>
               <h3 class="mb-0">{{ $leaveBalances['casual'] }} <span class="small text-slate" style="font-size: 28px;">leaves left</span></h3>
            </div>
        </div>
    </div>
