        ...
        <aside class="sidebar">
            <div class="sidebar-brand">
                ...
                <div>
                    ...
                    <p class="font-display mb-0" style="font-size:1.05rem; line-height:1.1;">{{ auth()->user()->name }}
                    </p>
            ...
            <nav class="sidebar-nav">
                @if (auth()->user()->isAdmin())
                    <a href="{{ route('dashboard') }}"
                        ...
                        <i class="fa-solid fa-magnifying-glass-chart"></i> Overview
                    </a>
                ...
                @else
                    <a href="{{ route('employees.dashboard') }}"
                        ...
                        <i class="fa-solid fa-chart-bar"></i> My Dashboard
                    </a>
                    <a href="{{ route('leaves.create') }}"
                        class="sidebar-link {{ request()->routeIs('leaves.create') ? 'active' : '' }}">
                        <i class="fa-solid fa-person-walking-arrow-right"></i> Apply Leave
                    </a>
                    <a href="{{ route('leaves.index') }}"
                        class="sidebar-link {{ request()->routeIs('leaves.index') ? 'active' : '' }}">
                        <i class="fa-brands fa-audible"></i> Leave History
                    </a>
            ...
            @auth
                ...
                <div class="sidebar-footer">
                    ...
                    <form method="POST" action="{{ route('logout') }}">
                        @csrf
                        <button type="submit" class="btn btn-sm w-100 text-start text-white-50"
